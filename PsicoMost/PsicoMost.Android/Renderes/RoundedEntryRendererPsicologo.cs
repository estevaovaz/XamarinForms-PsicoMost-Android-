...
[assembly: ExportRenderer(typeof(RoundedEntryPsicologo), typeof(RoundedEntryRendererPsicologo))]
namespace PsicoMost.Droid.Renderes
{
    public class RoundedEntryRendererPsicologo : EntryRenderer
    {
        public RoundedEntryRendererPsicologo(Context context) : base(context)
        {
        }
