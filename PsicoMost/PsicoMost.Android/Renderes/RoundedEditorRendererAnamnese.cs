...
[assembly: ExportRenderer(typeof(RoundedEditorAnamnese), typeof(RoundedEditorRendererAnamnese))]
namespace PsicoMost.Droid.Renderes
{
    public class RoundedEditorRendererAnamnese : EditorRenderer
    {
        public RoundedEditorRendererAnamnese(Context context) : base(context)
        {
        }
