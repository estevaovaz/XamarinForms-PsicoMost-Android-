...
[assembly: ExportRenderer(typeof(RoundedEntrySessao), typeof(RoundedEntryRendererSessao))]
namespace PsicoMost.Droid.Renderes
{
    public class RoundedEntryRendererSessao : EntryRenderer
    {
        public RoundedEntryRendererSessao(Context context) : base(context)
        {
        }
