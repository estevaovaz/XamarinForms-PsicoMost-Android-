...
[assembly: ExportRenderer(typeof(RoundedPickerSessao), typeof(RoundedPickerRendererSessao))]
namespace PsicoMost.Droid.Renderes
{
    public class RoundedPickerRendererSessao : PickerRenderer
    {
        public RoundedPickerRendererSessao(Context context) : base(context)
        {
        }
